...
function DHTMLgoodies_formTooltip()
{
	...
	this.imagePath = '../scripts/tooltip/images/';
...
DHTMLgoodies_formTooltip.prototype = {
	...
	__createTooltip : function()
	{
		...
		closeDiv.innerHTML = '<A class="DHTMLgoodies_formTooltip_closeMessage" href="#" style="text-decoration: none; color: #FFFFFF;" onclick="DHTMLgoodies_globalTooltipObj.__hideTooltipFromLink();return false">' + this.closeMessage + '</A>';
		
		if(this.disableTooltipPossibility){
			var tmpHTML = closeDiv.innerHTML;
			tmpHTML = tmpHTML + ' | <A class="DHTMLgoodies_formTooltip_closeMessage" href="#" style="text-decoration: none; color: #FFFFFF;" onclick="DHTMLgoodies_globalTooltipObj.disableTooltip();return false">' + this.disableTooltipMessage + '</A>';
